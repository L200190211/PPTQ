            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card profile-widget">
                        ...
                        <form action="/addcompid" id="addcompid" method="POST" enctype="multipart/form-data" class="needs-validation">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control" type="text" name="desc" id="desc" required style="height: 90px" required autofocusaria-describedby="basic-addon2"></textarea>
                                        <div class="invalid-feedback">
