                            ...
                            <form action="/editteamid/{{ $data->id }}" id="editteamid" method="POST"
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        {{-- data null --}}
                                        @if (is_null($data->sampul))
                                            <div id="imagePreview" style="background-image: url(/img/dummy/sampul.png);">
                                            </div>
                                            {{-- data available --}}
                                        @elseif (File::exists(public_path('img/sampul/' . $data->sampul)))
                                            <div id="imagePreview"
                                                style="background-image: url(/img/sampul/{{ $data->sampul }})">
                                            </div>
                                            {{-- file not found --}}
                                        @else
                                            <div id="imagePreview" style="background-image: url(/img/dummy/sampul.png);">
