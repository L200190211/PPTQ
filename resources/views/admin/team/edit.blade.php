            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card profile-widget">
                        ...
                        <form action="/editteamid/{{ $data->id }}" id="editteamid" method="POST" enctype="multipart/form-data" class="needs-validation">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label>Phone</label>
                                        <input type="tel" class="form-control" name="phone" value="{{ $data->phone }}" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                                        <div class="invalid-feedback">
