                                ...
                                <form action="regist/addregist" id="addregist" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input id="telf" type="number"
                                                oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                                class="form-control" name="telf">
                                            <div class="invalid-feedback">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input id="conf-password" type="password" class="form-control pwstrength"
                                                data-indicator="pwindicator" name="conf-password">
                                            <div id="pwindicator" class="pwindicator">
                                                <div class="bar"></div>
                                                <div class="label"></div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('psshb') }}" class="btn btn-warning btn-block">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
