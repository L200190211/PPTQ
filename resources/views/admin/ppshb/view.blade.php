                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control" value="{{ $datas->user->username }}"
                                                required="" name="username" disabled>
                                        </div>
                                        <div class="form-group col-md-6 col-12">
                                            <label>Name</label>
                                            <input type="text" class="form-control" value="{{ $datas->user->name }}"
                                                required="" name="name" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            <label>NISN</label>
                                            <input type="text" class="form-control" value="{{ $datas->user->nisn }}"
                                                name="nisn"
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input id="asal_sekolah" type="text" class="form-control" name="asal_sekolah"
                                                value="{{ $datas->user->asal_sekolah }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            <label>Email</label>
                                            <input type="email" class="form-control" value="{{ $datas->user->email }}"
                                                required="" name="email" disabled>
                                        </div>
                                        <div class="form-group col-md-6 col-12">
                                            <label>Phone</label>
                                            <input type="tel" class="form-control" value="{{ $datas->user->no_tlp }}"
                                                name="no_tlp"
                                                oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                                disabled>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <input id="tempat" type="text" class="form-control" name="tempat"
                                                value="{{ $datas->user->tempat_lahir }}" disabled>
                                        </div>
                                        <div class="form-group col-6">
                                            <label for="tgl_lahir">Tgl Lahir</label>
                                            <input type="date" class="form-control datepicker" id="tgl_lahir"
                                                name="tgl_lahir" value="{{ $datas->user->tgl_lahir }}" disabled>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <textarea class="form-control" type="text" name="deskripsi" id="deskripsi" required style="height: 90px" required
                                                placeholder="Masukkan Alamat Lengkap" aria-describedby="basic-addon2" disabled>{{ $datas->user->address }}</textarea>
                                        </div>
                                    </div>
                                </div>
                @endforeach
